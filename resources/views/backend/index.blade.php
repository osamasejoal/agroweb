	...
	***********************************-->
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head d-flex align-items-start" style="margin-bottom:2rem">
                <div class="me-auto d-none d-lg-block">
                    <h2 class="text-primary font-w600 mb-0">Dashboard</h2>
                    <p class="mb-0">Welcome to Agroweb!</p>
                </div>
                        ...
                        <div class="card-body tab-content orders-summary pt-3">
                            <div class="tab-pane fade show active" id="Monthly">
                                <div class="d-flex flex-wrap order-manage p-3 align-items-center mb-4">
                                    ...
                                    <a href="javascript:void(0);" class="ms-auto text-primary font-w500">Manage orders <i
                                ...
                                <div class="widget-timeline-icon">
                                    <div class="row align-items-center">
                                        <div
                                            class="col-xl-3 col-lg-2 col-xxl-4 col-sm-3 col-md-3 my-2 text-center text-sm-left">
                        ...
                        <div class="card-body revenue-chart px-3">
                            <div class="d-flex flex-wrap justify-content-end pe-3 pull-right revenue-chart-bar">
                                <div class="d-flex align-items-end me-4 mb-2">
                                    <img src="{{ asset('backend/assets') }}/images/svg/ic_stat2.svg" height="22"
                                        width="22" class="me-2 mb-1" alt="" />
                                    <div>
                                ...
                                <div class="d-flex align-items-end mb-2">
                                    <img src="{{ asset('backend/assets') }}/images/svg/ic_stat1.svg" height="22"
                                        width="22" class="me-2 mb-1" alt="" />
                                    <div>
                        ...
                        <div class="card-header border-0 pb-0 d-sm-flex d-block">
                            ...
                            <div class="card-action card-tabs mt-3 mt-sm-0">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#session-duration"
                                            role="tab">
                                            Today
                                        </a>
                                    </li>
