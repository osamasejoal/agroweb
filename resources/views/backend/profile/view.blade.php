                            ...
                            <div class="basic-form">
                                ...
                                <form action="{{ route('profile.update', auth()->id()) }}" method="post"
                                    ...
                                    <div class="mb-5 row">
                                        ...
                                        <div class="col-9">
                                            <img src="{{ asset('backend/assets/images/profile/' . auth()->user()->image) }}"
                                                id="preimg" alt="" style="width:150px;border-radius:5px;">
                                        </div>
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            @if ($errors->get('image'))
                                                ...
                                                @enderror
                                            @else
                                                <span class="text-muted">Image should be <b>jpg</b> and <b>square</b>
                                                    shape.</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="row col-12">
                                        <div class="col-sm-12 text-end">
                                            <a href="{{ route('profile.password.change') }}" class="text-info">Change your
                                                password!</a>
                                        </div>
                                    </div>
