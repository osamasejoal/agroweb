                ...
                <div class="col-xl-4 col-lg-12 col-sm-12" style="height:fit-content">
                    <div class="card overflow-hidden">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            @if (auth()->user()->role == 2)
                                <li class="list-group-item d-flex justify-content-between">
                                    <span class="mb-0">Joined</span>
                                    <strong class="text-muted">{{ auth()->user()->created_at->format('d/m/Y') }}</strong>
                                </li>
                            @elseif (auth()->user()->role == 3)
                                <li class="list-group-item d-flex justify-content-between">
                                    <span class="mb-0">With us from</span>
                                    <strong class="text-muted">{{ auth()->user()->created_at->diffForHumans() }}</strong>
                                </li>
                            @endif
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                ...
                                {{-- Form --}}
                                <form action="{{ route('profile.password.update') }}" method="post" class="row">
                                    @csrf
                                    ...
                                    <div class="mb-5 row">
                                        ...
                                        <div class="col-9">
                                            <input name="password" type="password" id="new_pass" class="form-control"
                                                style="font-size:18px">
                                    ...
                                    <div class="mb-5 row">
                                        ...
                                        <div class="col-9">
                                            <input name="password_confirmation" type="password" id="confirm_pass"
