...
@section('main-content')
                ...
                <div class="col-xl-6">
                    <div class="about-one__left">
                        <div class="section-title text-left">
                            <span class="section-title__tagline">Get to Know agroweb</span>
                            <h2 class="section-title__title">agroweb is the Agriculture and Organic farm</h2>
                            <div class="section-title__icon">
                                <img src="{{ asset('frontend') }}/assets/images/icon/section-title-icon-1.png"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="about-one__btn-and-ceo">
                            ...
                            <div class="about-one__ceo">
                                <div class="about-one__ceo-img">
                                    <img src="{{ asset('frontend') }}/assets/images/resources/about-one-ceo-img.jpg"
                                        alt="">
                                </div>
                                <div class="about-one__ceo-content">
                                    <h4 class="about-one__ceo-name">Mike Hardson</h4>
                                    <p class="about-one__ceo-title">CEO of agroweb</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="about-one__right">
                        <div class="about-one__img-box wow slideInRight" data-wow-delay="100ms"
                            ...
                            <div class="about-one__img-one">
                                <img src="{{ asset('frontend') }}/assets/images/resources/about-one-img-1.jpg"
                                    alt="">
                            </div>
                            <div class="about-one__img-two">
                                <img src="{{ asset('frontend') }}/assets/images/resources/about-one-img-2.jpg"
                                    alt="">
                            </div>
    ...
    <section class="services-one">
        <div class="services-one__bg"
            style="background-image: url({{ asset('frontend') }}/assets/images/shapes/services-one-shape-1.png);">
        </div>
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="services-one__single">
                        <div class="services-one__img-box">
                            <div class="services-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/services/services-one-1.jpg"
                                    alt="">
                            </div>
                        ...
                        <div class="services-one__content">
                            <h3 class="services-one__title"><a href="agriculture-products.html">Agriculture <br>
                                    Products</a></h3>
                            <p class="services-one__text">I was impresed by the agroweb services, not lorem ipsum is
                                simply free text.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="200ms">
                    <div class="services-one__single">
                        <div class="services-one__img-box">
                            <div class="services-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/services/services-one-2.jpg"
                                    alt="">
                            </div>
                            <div class="services-one__icon">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="300ms">
                    <div class="services-one__single">
                        <div class="services-one__img-box">
                            <div class="services-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/services/services-one-3.jpg"
                                    alt="">
                            </div>
                            <div class="services-one__icon">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="400ms">
                    <div class="services-one__single">
                        <div class="services-one__img-box">
                            <div class="services-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/services/services-one-4.jpg"
                                    alt="">
                            </div>
                            <div class="services-one__icon">
    ...
    <section class="unbeatable-one">
        <div class="unbeatable-one__bg  jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
            style="background-image: url({{ asset('frontend') }}/assets/images/backgrounds/unbeatable-one-bg.jpg);"></div>
        <div class="container">
            <div class="unbeatable-one__inner text-center">
                <div class="unbeatable-one__content">
                    <div class="unbeatable-one__shape-one wow slideInLeft" data-wow-delay="100ms"
                        data-wow-duration="2500ms">
                        <img src="{{ asset('frontend') }}/assets/images/shapes/unbeatable-shape-1.png" alt=""
                            class="float-bob-y">
                    </div>
                    <div class="unbeatable-one__shape-two wow slideInRight" data-wow-delay="100ms"
                        data-wow-duration="2500ms">
                        <img src="{{ asset('frontend') }}/assets/images/shapes/unbeatable-shape-2.png" alt=""
                            class="float-bob-y">
                    </div>
    ...
    <section class="healthy-food-one">
        <div class="healthy-food-one__bg float-bob-x"
            style="background-image: url({{ asset('frontend') }}/assets/images/shapes/healthy-food-one-shape-1.png);">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="healthy-food-one__left">
                        <div class="healthy-food-one__img">
                            <img src="{{ asset('frontend') }}/assets/images/resources/healthy-food-one-1.jpg"
                                alt="">
                        </div>
                    </div>
                </div>
    ...
    <section class="testimonial-one">
        <div class="testimonial-one-bg"
            style="background-image: url({{ asset('frontend') }}/assets/images/backgrounds/testimonial-one-bg.png);">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                                    ...
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img">
                                                <img src="{{ asset('frontend') }}/assets/images/testimonial/testimonial-1-1.jpg"
                                                    alt="">
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img">
                                                <img src="{{ asset('frontend') }}/assets/images/testimonial/testimonial-1-2.jpg"
                                                    alt="">
                                                <div class="testimonial-one__quote">
                                                    <span class="icon-quote"></span>
                                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img">
                                                <img src="{{ asset('frontend') }}/assets/images/testimonial/testimonial-1-3.jpg"
                                                    alt="">
                                                <div class="testimonial-one__quote">
                                                    <span class="icon-quote"></span>
                                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img">
                                                <img src="{{ asset('frontend') }}/assets/images/testimonial/testimonial-1-4.jpg"
                                                    alt="">
                                                <div class="testimonial-one__quote">
                                                    <span class="icon-quote"></span>
                                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img">
                                                <img src="{{ asset('frontend') }}/assets/images/testimonial/testimonial-1-5.jpg"
                                                    alt="">
                                                <div class="testimonial-one__quote">
                                                    <span class="icon-quote"></span>
                                                </div>
                            ...
                            <div class="item">
                                <div class="testimonial-one__single">
                                    <div class="testimonial-one__content">
                                        ...
                                        <div class="testimonial-one__client-info">
                                            <div class="testimonial-one__client-img">
                                                <img src="{{ asset('frontend') }}/assets/images/testimonial/testimonial-1-6.jpg"
                                                    alt="">
                                                <div class="testimonial-one__quote">
                                                    <span class="icon-quote"></span>
                                                </div>
    ...
    <section class="counter-one">
        <div class="counter-one__bg"
            style="background-image: url({{ asset('frontend') }}/assets/images/shapes/counter-one-shape-3.png);">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
    ...
    <section class="project-one">
        <div class="project-one__bg float-bob-y-2"
            style="background-image: url({{ asset('frontend') }}/assets/images/shapes/project-one-shape-1.png);">
        </div>
        <div class="container">
            <div class="section-title text-center">
            ...
            <div class="row">
                    ...
                    <div class="project-one__single">
                        <div class="project-one__inner">
                            <div class="project-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/project/project-one-1.jpg"
                                    alt="">
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="project-one__single">
                        <div class="project-one__inner">
                            <div class="project-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/project/project-one-2.jpg"
                                    alt="">
                            </div>
                            <div class="project-one__arrow">
                                <a href="project-details.html"><i class="icon-right-arrow"></i></a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="project-one__single">
                        <div class="project-one__inner">
                            <div class="project-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/project/project-one-3.jpg"
                                    alt="">
                            </div>
                            <div class="project-one__arrow">
                                <a href="project-details.html"><i class="icon-right-arrow"></i></a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="project-one__single">
                        <div class="project-one__inner">
                            <div class="project-one__img">
                                <img src="{{ asset('frontend') }}/assets/images/project/project-one-4.jpg"
                                    alt="">
                            </div>
                            <div class="project-one__arrow">
                                <a href="project-details.html"><i class="icon-right-arrow"></i></a>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="contact-one__right">
                        <div class="contact-one__bg float-bob-x"
                            style="background-image: url({{ asset('frontend') }}/assets/images/shapes/contact-one-shape-1.png);">
                        </div>
                        <div class="row">
                            <div class="contact-one__form-box">
                                <form action="https://layerdrops.com/agrowebhtml/main-html/assets/inc/sendemail.php"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                    <div class="blog-one__single">
                        <div class="blog-one__img">
                            <img src="{{ asset('frontend') }}/assets/images/blog/blog-one-1.jpg" alt="">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                    <div class="blog-one__single">
                        <div class="blog-one__img">
                            <img src="{{ asset('frontend') }}/assets/images/blog/blog-one-2.jpg" alt="">
                            <div class="blog-one__date">
                                <span>28</span>
                                <p>Aug</p>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                    <div class="blog-one__single">
                        <div class="blog-one__img">
                            <img src="{{ asset('frontend') }}/assets/images/blog/blog-one-3.jpg" alt="">
                            <div class="blog-one__date">
                                <span>28</span>
                                <p>Aug</p>
                            </div>
    ...
    <section class="cta-one">
        <div class="cta-one__bg" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
            style="background-image: url({{ asset('frontend') }}/assets/images/backgrounds/cta-one-bg.jpg);"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
